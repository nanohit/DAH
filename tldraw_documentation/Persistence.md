...
Tldraw supports a couple of ways of adding custom data types to the tldraw store:
    ...
    Custom shape types
    meta properties on all of our built-in record types.
...
To enable this, tldraw provides two ways to add custom migrations:
    ...
    Shape props migrations, specifically for migrating the shape.props objects on your custom shape types.
    The migrations config option, which is more general purpose but much less commonly needed. This will allow you to migrate any data in the store.
...
You can convert your legacy migrations to the new migrations format by the following process:
    ...
    Wrap your version numbers in createShapePropsMigrationIds
...
+ })
    ...
    Replace your defineMigrations call with createShapePropsMigrationSequence
